...
- Clarification: Executable scripts provided by this gem (exe/* and installed binstubs) work when the gem is installed as a system gem (gem install kettle-test). However, the Rake tasks provided by this gem require kettle-test to be declared as a development dependency in the host project's Gemfile and loaded in the project's Rakefile.
