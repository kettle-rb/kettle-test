...
# kettle-test Rakefile v1.0.0 - 2026-04-03
...
# rake kettle:jem:install                     # Install kettle-test GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template kettle-test against itse...
# rake kettle:jem:template                    # Template kettle-test files into the curren...
