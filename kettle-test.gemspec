...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency("turbo_tests2", "~> 3.1", ">= 3.1.2")             # ruby >= 2.4.0, shared RSpec helpers for spawned subprocess specs
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.1")      # ruby >= 2.4
